...
<head>
	...
	<title>Page Not Found | The Green Perch</title>
	...
	<div class="flex containerBlock">
		<div class="flex flexCol container">
			...
			<div class="flex flexCol" style="height: 500px; width: 100%; padding-top: 50px; align-items: center; justify-content: center; gap: 40px;">
				<div>
					<img src="/greenperch/assets/images/bird.png" alt="404" style="height: 250px; width: 250px;">
				</div>

				<span class="flex flexCol" style="align-items: center; justify-content: center; gap: 10px;">
					<h1 style="font-weight: 600;">Not Found</h1>
					<p style="font-size: 20px;">Uh oh! Looks like the page you're looking for doesn't exist.</p>
				</span>

				<a class="anchorBtn" href="/greenperch/">Go to Homepage</a>
			</div>
