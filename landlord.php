<?php
if (!isset($_COOKIE['role']) || $_COOKIE['role'] != 'Landlord') {
...
<head>
	...
	<title>Dashboard - Landlord | The Green Perch</title>
...
<body>
	...
	<div class="flex containerBlock">
		...
		<?php
		include 'templates/landlord/requests.html';
		include 'templates/landlord/properties.html';
		include 'templates/landlord/addproperty.html';
		?>
